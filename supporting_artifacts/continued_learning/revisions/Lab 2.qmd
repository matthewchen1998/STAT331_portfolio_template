...
Answer: There are 30463 observations and 15 columns in the dataset.
...
Answer: There are both numeric and character data types in the dataset.
...
ggplot(data = surveys, mapping = aes(x = weight, y = hindfoot_length))+geom_point(alpha = 1/9)+
   labs(x = "Weight (gm)", y = "hindfoot length (mm)")
...
ggplot(data = surveys,
  ...
  geom_boxplot()+
   labs(x = "Animal Species", y = "Weight (gm)")
...
ggplot(data = surveys,
  ...
  geom_boxplot(outlier.shape = NA)+
  geom_jitter(color = "green")+
   labs(x = "Animal Species", y = "Weights of the Animals (gm)")
